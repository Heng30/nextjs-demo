...
export default function New() {
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center">
      <form action={createSnippetAction} className="font-bold m-3 mx-auto w-2/3">
        ...
        <div className="flex flex-col gap-4">
          ...
          {
            formState.message ? <div className="bg-red-200 p-2 border rounded border-red-400">{formState.message}</div> : null
          }
