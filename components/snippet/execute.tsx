      ...
      <div className="font-bold m-3 mx-48 w-full">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex gap-4">
            ...
            <div className="border rounded p-2 w-full bg-white">{props.title}</div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div className="border rounded p-2 w-full min-h-48 bg-white">{props.code}</div>
          </div>
          ...
          <div className="flex flex-col gap-8 w-full">
            <div className="flex gap-4">
              ...
              <div className="border rounded p-2 w-full min-h-32 bg-gray-300">{output}</div>
            </div>

            <button className="text-black rounded bg-blue-200 p-4 w-full" onClick={() => setOutput(runCode(props.code))}>
              Execute
            </button>
          </div>
        </div>
